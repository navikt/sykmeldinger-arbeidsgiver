    ...
    FunSpec({
        ...
        context("test database") {
            test("Save ArbeidsgiverSykmelding") {
                val arbeidsgiverSykmelding: SykmeldingArbeidsgiverKafkaMessage =
                ...
                val person =
                    PdlPerson(
                        navn = Navn("Fornavn", mellomnavn = "Mellomnavn", "Etternavn"),
                        aktorId = null
                    )
                ...
                savedSykmelding.orgNavn shouldBeEqualTo
                    arbeidsgiverSykmelding.event.arbeidsgiver?.orgNavn
            ...
            test("Save ArbeidsgiverSykmelding with updated name and tom") {
                ...
                val newSykmelding =
                    arbeidsgiverSykmelding.copy(
                        sykmelding =
                            arbeidsgiverSykmelding.sykmelding.copy(
                                id = "1234",
                                sykmeldingsperioder =
                                    arbeidsgiverSykmelding.sykmelding.sykmeldingsperioder.map {
                                        it.copy(
                ...
                database.insertOrUpdateSykmeldingArbeidsgiver(
                    newSykmelding,
                    person.copy(Navn("Test", null, "Tester")),
                    newSykmelding.sykmelding.sykmeldingsperioder.maxOf { it.tom }
                )

                val saved = database.getArbeidsgiverSykmeldinger("lederFnr")
                saved.filter { it.sykmelding == newSykmelding.sykmelding }.size shouldBeEqualTo 1
                saved
                    .filter { it.sykmelding == arbeidsgiverSykmelding.sykmelding }
            ...
            test("Get ArbeidsgiverSykmeldinger from leder fnr") {
                ...
                database.getAnsatt(nl.narmesteLederId.toString(), "lederFnr") shouldBeEqualTo
                    Ansatt(
                        "12345678901",
                ...
                database.insertOrUpdateSykmeldingArbeidsgiver(
                    arbeidsgiverSykmelding.copy(
                        sykmelding = arbeidsgiverSykmelding.sykmelding.copy(id = "1234"),
                        event =
                            arbeidsgiverSykmelding.event.copy(
                                arbeidsgiver =
                                    arbeidsgiverSykmelding.event.arbeidsgiver!!.copy(
                                        orgnummer = "123456788"
                                    )
                            )
                    ),
                ...
                database.insertOrUpdateSykmeldingArbeidsgiver(
                    arbeidsgiverSykmelding.copy(
                        sykmelding = arbeidsgiverSykmelding.sykmelding.copy(id = "12345")
                    ),
                    person.copy(navn = person.navn.copy(mellomnavn = null)),
                    arbeidsgiverSykmelding.sykmelding.sykmeldingsperioder.maxOf { it.tom }
                )
            ...
            test("Get ArbeidsgiverSykmeldinger from leder fnr and narmeste leder id") {
                ...
                narmestelederDb.insertOrUpdate(nl)
                database
                    .getArbeidsgiverSykmeldinger(
                        lederFnr = nl.narmesteLederFnr,
                        narmestelederId = nl.narmesteLederId.toString()
                    )
                    .size shouldBeEqualTo 1

                val nyArbeidsgiverSykmelding =
                    getSykmeldingArbeidsgiverKafkaMessage(
                        LocalDate.now(),
                        LocalDate.now(),
                ...
                database.insertOrUpdateSykmeldingArbeidsgiver(
                    nyArbeidsgiverSykmelding,
                    person,
                    nyArbeidsgiverSykmelding.sykmelding.sykmeldingsperioder.maxOf { it.tom }
                )
                database
                    .getArbeidsgiverSykmeldinger(
                        lederFnr = nl.narmesteLederFnr,
...
fun getSykmeldingArbeidsgiverKafkaMessage(
    fom: LocalDate,
    tom: LocalDate,
    sykmeldingsId: String = UUID.randomUUID().toString(),
